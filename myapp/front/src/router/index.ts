  ...
  routes: [
    ...
    { path: '/forgot-password', name: 'forgot', component: () => import('../views/ForgotPasswordView.vue') },
    {
      ...
      children: [
        ...
        { path: 'device/:id', name: 'device-detail', component: () => import('../views/DeviceDetailView.vue') },
        { path: 'device/:id/edit', name: 'device-edit', component: () => import('../views/DeviceEditView.vue') },
      ],
    },
  ],
})

CREATE DATABASE IF NOT EXISTS `twsny_prod` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
CREATE DATABASE IF NOT EXISTS `twsny_test` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
